...
const stepTypeStyles: Record<StepType, string> = {
  TASK:         'bg-purple-900/40 text-purple-300 border border-purple-800/50',
  APPROVAL:     'bg-orange-900/40 text-orange-300 border border-orange-800/50',
  NOTIFICATION: 'bg-cyan-900/40 text-cyan-300 border border-cyan-800/50',
};
...
export function Spinner({ className }: { className?: string }) {
  return (
    <svg
      className={clsx('animate-spin', className ?? 'w-5 h-5 text-brand-400')}
